...
K and Na will fully dissolved into water, colourless gas bubbles given out and the solution become warmer. 
...
==The metal dissolved in the acid and colourless gas bubbles are given out ==
...
==The $\displaystyle\ce{ Cu^{2}+ }$ turn the solution gradually turns pale blue
...
$$
Not that nitrate ions do not take part in the reaction and known as ==spectator ions==(Ps: spectator ion must be mobile ion)
...
> [!IMPORTANT]
> 
==If no spectator ion present, no ionic equation==\
The spectator ion must be aqueous state [[Solubility of Ion compound]]
